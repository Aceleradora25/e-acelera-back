...
describe("StackbyService", () => {
    ...
    describe("fetchStackbyData", () => {
        ...
        it("retorna dados em caso de sucesso", async () => {
            ...
            fetch.mockResolvedValue({ json: mockJson, ok: true });
            const result = await service.fetchStackbyData("endpoint", null);
            expect(fetch).toHaveBeenCalledWith(expect.stringContaining("http://fakeurl/endpoint"), expect.objectContaining({
    ...
    describe("calculateTotalItems", () => {
        it("calcula corretamente para THEMES", () => {
            ...
            const result = service.calculateTotalItems("theme1", StackbyEndpoint.THEMES, mockThemes, mockTopics);
        ...
        it("calcula corretamente para TOPICS", () => {
            ...
            const result = service.calculateTotalItems("topic1", StackbyEndpoint.TOPICS, mockTopics);
