/*
  ...
  - The values [Selftudy] on the enum `ThemeCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ThemeCategory_new" AS ENUM ('Leveling', 'SelfStudy');
